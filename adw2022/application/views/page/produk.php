                   ...
                   <div class="card-body p-10">
                       <!-- <div class="card card-primary">
                               ...
                               <div class="row">
                                   <div class="col-lg-4">
                                       <div class="form-group">
                                           <label>Tahun</label>
                                           <select class="form-control" id="tahun3">
                                   ...
                                   <div class="col-lg-4">
                                       <div class="form-group">
                                           <label>Kuartal</label>
                                           <select class="form-control" id="kuartal3">
                                               <option value="all" selected>Semua</option>
                                   ...
                                   <div class="col-lg-4">
                                       <div class="form-group">
                                           <label>Bulan</label>
                                           <select class="form-control" id="bulan3">
                                               <option value="all" selected>Semua</option>
                           ...
                           <div class="card-footer">
                               <button class="btn btn-primary float-right" role="button" id="gen3">Generate</button>
                           </div>
                       </div> -->
                       <br>
